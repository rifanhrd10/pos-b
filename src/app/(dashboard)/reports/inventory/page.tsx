...
interface PageProps {
  searchParams: Promise<{ outletId?: string; categoryId?: string }>
}
...
export default async function InventoryReportPage({ searchParams }: PageProps) {
  ...
  const { outletId, categoryId } = await searchParams
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Laporan stok inventori produk per outlet"
        breadcrumb="Laporan / Inventori"
        actions={
          <ExportExcelButton
            data={exportData}
