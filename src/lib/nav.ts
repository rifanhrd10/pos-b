...
export const navItems: NavItem[] = [
  ...
  { href: "/settings/payment", label: "Metode Pembayaran", icon: Wallet, permission: "settings.manage" },
  ...
  { href: "/settings/account", label: "Akun", icon: UserCog, permission: "settings.manage" },
  ...
  { href: "/inventory/adjustments", label: "Penyesuaian", icon: SlidersHorizontal, permission: "inventory.view" },
  { href: "/inventory/transfers", label: "Transfer", icon: ArrowRightLeft, permission: "inventory.view" },
  { href: "/inventory/opname", label: "Stok Opname", icon: ClipboardCheck, permission: "inventory.view" },
