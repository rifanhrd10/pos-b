...
export const navItems: NavItem[] = [
  ...
  { href: "/master-variants", label: "Master Varian", icon: SlidersHorizontal, permission: "products.manage" },
  { href: "/master-toppings", label: "Master Topping", icon: Tag, permission: "products.manage" },
  ...
  { href: "/reports/inventory", label: "Laporan Stock", icon: Package, permission: "reports.view" },
...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: ["/products", "/categories", "/master-variants", "/master-toppings"],
  },
  {
    label: "Inventori",
    description: "Kelola stok opname.",
    items: ["/inventory/opname"],
  },
  {
